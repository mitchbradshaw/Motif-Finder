...
export const PAGES: PageDef[] = [
  ...
  P('review.inspector', 'Review', 'Queue', 'one candidate at a time', 'review/queue/q-12', ['review/review-1-candidate', 'review/review-1b-other-channels', 'review/review-3-queue-open', 'review/review-4-evidence-open', 'review/review-5-blind-verification', 'review/review-6-seed-promoted', 'review/review-7-batch-undone'], ['queue rail', 'candidate', 'verdict bar', 'evidence rail']),
  P('review.cluster', 'Review', 'Cluster', 'seed-search matches with member strip', 'review/queue/q-15/cluster/12', ['review/review-2-cluster'], ['cluster', 'member strip', 'verdicts']),
