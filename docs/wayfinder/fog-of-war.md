...
- **Status** — `out of scope` — the user decided on 2026-09-21 that cross-workspace writes need not register an owner for v1; kept here as a possible future implementation (a shared queue/job registry) so it is not rediscovered as fog.
